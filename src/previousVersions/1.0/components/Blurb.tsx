...
const Blurb: Component<Props> = (props) => {
  ...
  const shouldBreakLine = () =>
    windowWidth() < 500 || (windowWidth() < 850 && windowWidth() > 630);
  ...
  return (
    <div
      class={`absolute right-0 top-0 w-full p-5p pt-7vp flex flex-col animate-pop-in sm:w-2/3 sm:pl-10p sm:mb-0 sm:pb-7vp sm:pt-8vp`}
      style={{ bottom: `${Math.ceil(props.imgTop)}px` }}
    >
      <div class="text-black bg-white bg-opacity-70 z-10 rounded-sm shadow-2xl flex-grow overflow-y-auto overflow-x-hidden scrollbar-custom max-h-fit flex flex-col justify-between">
        <div class="p-5p">
          ...
          <p>
            ...
            at Yale University studying computer science. Welcome to my website!{" "}
          </p>
          <br />
          <p>
            ...
            <a href="/resumes/resume1.0.pdf" target="_blank" class="link">
              resume
            </a>
            .
          </p>
          ...
          <br />
          <p>
            Aside from coding, I am also the cofounder of a pineapple soap
            business on campus, president of the&nbsp;
            <a
          ...
          <br />
          <p>
            I'm currently working on building my website using Solid.js and
            Tailwind CSS.&nbsp;
            <a
        ...
        <p class="italic bottom-0 text-gray-400 text-xs text-center p-1">
          This website has a few hidden secrets, try clicking "Addison Goolsbee"
        </p>
      </div>
